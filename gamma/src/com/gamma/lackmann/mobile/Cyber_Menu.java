...
public class Cyber_Menu extends Activity 
{
	Context ctx = this;	
	
	TextView cybmon, cybtues, cybwed, cybthurs, cybfri,
    ...
    public void readdinner() throws IOException
    {
    	...
    	try 
    	{
			...
			cybmon.setOnClickListener(new View.OnClickListener() 
			{
				...
				{
					parse_nutrition(1, 19, meal_name[0]);		
				}
			}); 
			...
			cybtues.setOnClickListener(new View.OnClickListener() 
			{
				public void onClick(View v) 
				{
					parse_nutrition(3, 19, meal_name[1]);		
				}
			}); 
			...
			cybwed.setOnClickListener(new View.OnClickListener() 
			{
				public void onClick(View v) 
				{
					parse_nutrition(5, 19, meal_name[2]);		
				}
			}); 
			...
			cybthurs.setOnClickListener(new View.OnClickListener() 
			{
				public void onClick(View v) 
				{
					parse_nutrition(7, 19, meal_name[3]);		
				}
			}); 
			...
			cybfri.setOnClickListener(new View.OnClickListener() 
			{
				public void onClick(View v) 
				{
					parse_nutrition(9, 19, meal_name[4]);		
				}
			}); 
	...
	{
    	cybmon = (TextView) findViewById(R.id.mondinner);
        cybtues = (TextView) findViewById(R.id.tuesdinner);
        cybwed = (TextView) findViewById(R.id.wedsdinner);
        cybthurs = (TextView) findViewById(R.id.thursdinner);
        cybfri = (TextView) findViewById(R.id.fridinner);
